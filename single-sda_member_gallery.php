...
<main id="post-<?php the_ID(); ?>">
    ...
    <div class="jumbotron-container clearfix">
  	...
  	<div class="container">
  	<div class="row indented-container filter-section">
		...
		<div class="col-sm-2 directory-filter-container">
         	<label for="select-media" class="directory-label">Materials:</label>
	         	...
	         	<?php if( have_rows('materials') ): ?>
			 		...
			 		<select class="selectpicker">
		     			...
		     			?>
			 				...
			 				<option><?php echo $materials_option; ?></option>
					...
					<select class="selectpicker">
						...
						$techniques_option = get_sub_field('techniques_option');
	     				?>
		 					...
		 					<option><?php echo $techniques_option; ?></option>
