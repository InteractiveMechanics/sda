...
?>
  ...
  <main>
    ...
    <div class="container">
      ...
      <form action="<?php the_permalink(); ?>" method="POST" id="products-form">
  	...
  	<section class="history-section" id="products-text">
    	<div class="container">
			<div class="row indented-container">
				<?php echo $page_body; ?>
  ...
  <section class="directory-table" id="products-table">
    <div class="container">
      <div class="row indented-container">
        <table class="table">
          <thead>
  ...
  <div class="container">
      <div class='row pagination-container' id="products-pagination">
	      <nav>
              <ul class="pager">
                <?php if ($page > 1): ?>
